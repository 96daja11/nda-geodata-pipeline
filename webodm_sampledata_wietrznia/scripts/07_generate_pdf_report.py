#!/usr/bin/env python3
"""
Steg 7 — Generera sammanfattande PDF-rapport (Wietrznia)
Sammanfattar all data, siffror och figurer från stegen 0–6 (inkl. 5b trädanalys)
...
OUT_PDF   = REPS / "geodata_analys_rapport_wietrznia.pdf"
REPS.mkdir(parents=True, exist_ok=True)

print("=" * 60)
print("STEG 7 — GENERERA PDF-RAPPORT (WIETRZNIA)")
print("=" * 60)
...
if tree_json.exists():
    ...
    print("  Varning: 05b_tree_analysis.json saknas — kör steg 5b först.")
...
<div class="cover">
  <div>
    ...
    <div class="cover-sub">
      Dataset: Wietrznia &mdash; Grönområde med bergsterräng<br/>
      Analyskedja: steg 0–6 inkl. 5b trädanalys | GPU-accelererad
    </div>
    ...
    <div class="cover-meta">
      ...
      <div class="cover-meta-item">
        ...
        <span>EPSG:32633 (UTM Zone 33N)</span>
      </div>
      <div class="cover-meta-item">
  ...
  <div class="cover-footer">
    Geodata Analysis Pipeline · Wietrznia · Intern teknisk rapport · All data bearbetad lokalt · {date_str}
  </div>
</div>
...
<div class="page">
  ...
  <div class="callout">
    ...
    CRS konsistent (EPSG:32633, UTM Zone 33N) · Upplösning 0.05 m/px ·
  ...
  <div class="two-col">
    ...
    <div>
      ...
      <p><strong>Obs:</strong> Hög vegetationsandel (klass 3–5) speglar det trädtäta Wietrznia-grönområdet.</p>
    </div>
  </div>
</div>
...
<div class="page">
  ...
  <div class="callout">
    ...
    Wietrznia-terrängen präglas av bergsluttningar mot schaktliknande fördjupningar — höga lutningsvärden förväntas.
  </div>
...
<div class="page">
  ...
  <div class="metric-grid">
    <div class="metric">
      ...
      <div class="key">Fördjupningar (≥ 5 m²)</div>
    </div>
    <div class="metric">
      <div class="val">{n_ups}</div>
      <div class="key">Upphöjningar (≥ 5 m²)</div>
    </div>
    <div class="metric">
  ...
  <div class="callout">
    Multi-skala lokal avvikelseanalys (radier 5.0, 10.0, 20.0 m) anpassade för Wietrznia-datasetet med
    GPU-accelererade uniform-filter (CuPy). Tröskelvärde: −0.50 m (fördjupning) / +0.60 m (upphöjning).
    Minsta area: 5 m². Förhöjda trösklar kompenserar för vegetationseffekter i DTM.
  </div>
...
<div class="page">
  ...
  <div class="callout green">
    <strong>Wietrznia är ett trädtätt grönområde.</strong> CHM-baserad träddetektering via lokala maxima
    (min_distance=8 px, threshold=2.0 m) följt av watershed-segmentering identifierar individuella kronor.
...
<div class="page">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td>3 — Anomalier</td><td>Multi-skala lokal avvikelse (r=5/10/20 m)</td><td>cupyx, scipy.ndimage</td><td>CuPy uniform_filter</td></tr>
      ...
      <tr><td>5b — Trädanalys</td><td>CHM lokala maxima → watershed kronor, stats</td><td>skimage, scipy, CuPy</td><td>CuPy gaussian + bincount</td></tr>
  ...
  <p>
    Träddetekteringen med lokala maxima kan underskatta antalet träd i tätt överlappande
    krontak (<em>closed canopy</em>) där enskilda toppar inte är synliga i CHM.
    Watershed-segmentering med kompactness=0.001 ger rimliga kronformer men
    kronareorna bör betraktas som approximationer.
  </p>
  <p>
    Anomalidetekteringen är anpassad med förhöjda trösklar (±0.5/0.6 m) för att
    kompensera för vegetationsrelaterat brus i DTM-ytan.
  </p>
</div>

<footer>
  <span>Geodata Analysis Pipeline — Wietrznia — Intern rapport</span>
  <span>Genererad: {date_str} | EPSG:32633</span>
  <span>Wietrznia 2025</span>
</footer>
...
# ── Write HTML ─────────────────────────────────────────────────────────────────
html_path = REPS / "geodata_analys_rapport_wietrznia.html"
